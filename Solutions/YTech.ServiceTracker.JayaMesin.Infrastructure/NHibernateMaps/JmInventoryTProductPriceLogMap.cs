...
{
    public partial class JmInventoryTProductPriceLogMap : IAutoMappingOverride<JmInventoryTProductPriceLog>
    {
        public void Override(FluentNHibernate.Automapping.AutoMapping<JmInventoryTProductPriceLog> mapping)
        {
            #region Properties
            ...
            mapping.Table("[dbo].[JM_INVENTORY_T_PRODUCT_PRICE_LOG]");
