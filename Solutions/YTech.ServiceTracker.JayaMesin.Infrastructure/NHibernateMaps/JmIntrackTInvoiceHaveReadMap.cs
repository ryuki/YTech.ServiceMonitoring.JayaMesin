...
{
    public partial class JmIntrackTInvoiceHaveReadMap : IAutoMappingOverride<JmIntrackTInvoiceHaveRead>
    {
        public void Override(FluentNHibernate.Automapping.AutoMapping<JmIntrackTInvoiceHaveRead> mapping)
        {
            #region Properties
            ...
            mapping.Table("dbo.JM_INTRACK_T_INVOICE_HAVE_READ");
            mapping.ReadOnly();
            mapping.Id(x => x.Id, "INVOICE_ID")
                 .GeneratedBy.Assigned();


            //mapping.Map(x => x.Id, "INVOICE_ID");
            ...
            mapping.Map(x => x.HaveBeenRead, "HaveBeenRead").ReadOnly().Not.Insert().Not.Update();
            #endregion
        }
    }
}
